...
const CATEGORIES = [
  { label: "Bridal Makeup",       img: "/portfolio/IMG_5347.JPG", href: "/services#bridal" },
  { label: "Editorial / Fashion", img: "/portfolio/IMG_6103.JPG", href: "/services#editorial" },
  { label: "Destination Wedding", img: "/portfolio/IMG_3256.JPG", href: "/services#destination" },
  { label: "Studio Appointment",  img: "/portfolio/IMG_1866.JPG", href: "/services#studio" },
];
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {CATEGORIES.map((c) => (
              <a
                key={c.label}
                href={c.href}
                className="group rounded-2xl border border-border/70 bg-background/40 p-2 shadow-sm transition hover:bg-accent/10"
              >
