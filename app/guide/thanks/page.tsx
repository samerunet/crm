  ...
  return (
    <div className="f-container section-y">
      <div className="glass rounded-[var(--radius-xl)] p-10 md:p-14">
        ...
        <p className="opacity-90 mb-4">Your payment {status === 'succeeded' ? 'was successful' : `status: ${status}`}. We&apos;re starting your download now and will also email a one-time-use backup link to the address used at checkout. Save the PDF as soon as it opens.</p>
        <div className="mb-4">
