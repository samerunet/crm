...
const DELIVERY_SECRET = process.env.STRIPE_SECRET_KEY || "dev-guide-download-secret";
...
function sign(encodedPayload: string) {
  return crypto.createHmac("sha256", DELIVERY_SECRET).update(encodedPayload).digest("base64url");
}
